...
def draw_main_menu(screen, btn_jugar, btn_salir, mouse_pos):
    # --- MAIN MENU ---
    Tools.draw_text(screen, "Infinite Hell", 72, (200, 50, 50), settings.WIDTH // 2 - 180, settings.HEIGHT // 4)
    
    draw_button(screen, btn_jugar, "Play", (50, 160, 50), (70, 200, 70), mouse_pos)
    draw_button(screen, btn_salir, "Exit", (180, 50, 50), (220, 70, 70), mouse_pos)
...
def draw_game_over_menu(screen, btn_reintentar, btn_salir, mouse_pos):
    ...
    Tools.draw_text(screen, "You are dead", 72, (255, 50, 50), settings.WIDTH // 2 - 200, settings.HEIGHT // 4)
    
    draw_button(screen, btn_reintentar, "Try again", (50, 120, 180), (70, 150, 220), mouse_pos)
    draw_button(screen, btn_salir, "Exit", (180, 50, 50), (220, 70, 70), mouse_pos)